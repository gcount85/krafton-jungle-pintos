...
struct page* spt_find_page(struct supplemental_page_table* spt UNUSED, void* va UNUSED)
{
    ...
    struct hash_elem* e = hash_find(&spt->hash, &page->elem);
    free(page);
    if (!e)
    {
        return NULL;
...
// addr - Fault address.
// user - True: not-present page, false: writing r/o page.
// write - True: access was write, false: access was read.
// not_present - True: access by user, false: access by kernel.
